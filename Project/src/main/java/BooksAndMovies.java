...
public class BooksAndMovies {
    public static class BooksAndMoviesMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public static class BooksAndMoviesReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text userId, Iterable<Text> records, Context context)
            ...
            for(Text record : records){
                ...
                // temp[] = {User_Id, Book_Id, Book_Rating, User_Id, Movie_Id, Movie_Rating}
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: BookAndMovies <in> <out>");
            System.exit(2);
        }
        Job job = new Job(conf, "Average BookAndMovies");
        job.setJarByClass(BooksAndMovies.class);
        job.setMapperClass(BooksAndMoviesMapper.class);
        job.setReducerClass(BooksAndMoviesReducer.class);
